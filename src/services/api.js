...
export const employer = {
  getDashboardStats: () => api.get('/employer/stats'),
  getApplications: (status) => api.get('/employer/applications', { params: { status } }),
};

// Subscription/Payment endpoints
export const payments = {
  createSubscription: (planId) => api.post('/payments/create-subscription', { planId }),
