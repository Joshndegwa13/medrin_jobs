...
const EXCHANGE_RATE = 153.50; // USD to KES rate (you can make this dynamic with an API)
...
const PricingPlans = () => {
  ...
  const formatInterval = (interval, price) => {
              ...
              <div className="p-6">
                ...
                <div className="mb-6">
                  ...
                  <span className="text-gray-600">
                    {formatInterval(plan.interval, plan.price)}
                  </span>
                </div>
